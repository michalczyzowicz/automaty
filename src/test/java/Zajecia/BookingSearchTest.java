...
public class BookingSearchTest {
	...
	/*
	 * @Test public void welcomePopup() { WebDriverWait wait = new
	...
	/*
	 * @Test public void currency() { WebElement currencyMain =
	 * driver.findElement(By.className("uc_currency")); currencyMain.click();
	 * WebDriverWait wait = new WebDriverWait(driver, 10);
	 * wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
	 * By.xpath("//ul[@class='currency_list']/li/a/span[@class='selsymbol']")));
	 * List<WebElement> currencyPopup = driver .findElements(By.xpath(
	 * "//ul[@class='currency_list']/li/a/span[@class='selsymbol']")); for
	 * (WebElement e : currencyPopup) { if (e.getText().equals("TWD"))
	 * e.click(); } }
	 */
