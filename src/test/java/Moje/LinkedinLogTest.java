...
public class LinkedinLogTest {
	...
	public static void tearsDown() throws AWTException, IOException {
		Robot r = new Robot();
		BufferedImage img = r.createScreenCapture(new Rectangle(0, 0, 1382, 750));
		File path = new File ("D://Testowanie//screen1.jpg");
	...
	public void test04() throws InterruptedException {
		...
		newTab.sendKeys(Keys.CONTROL + "t").build().perform();;
